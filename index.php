...
<div class="home-bg">
   ...
   <section class="home">
      ...
      <div class="content">
         <h3>Cultivating freshness, delivering quality..</h3>
         <p>Nourishing your community with the finest crops from San Jose.</p>
...
<section class="products">
   ...
   <form action="" class="box" method="POST">
      ...
      <input type="hidden" name="p_image" value="<?= $fetch_products['image1']; ?>">
